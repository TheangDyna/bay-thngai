...
export function RegisterRoutes(app: Router) {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(AuthController.prototype.getHealth),

    async function AuthController_getHealth(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
  ...
  app.post(
    ...
    async function AuthController_verifyUser(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(
      AuthController.prototype.resendVerifyUser
    ),

    async function AuthController_resendVerifyUser(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(AuthController),
    ...fetchMiddlewares<RequestHandler>(
      AuthController.prototype.loginWithFacebook
    ),

    async function AuthController_loginWithFacebook(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
  ...
  app.get(
    ...
    async function AuthController_oauthCallback(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
