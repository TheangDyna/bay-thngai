...
class UserRepository {
  ...
  async addFavorite(userId: string, jobId: string): Promise<IUser> {
    try {
      ...
      console.error(`UserRepository - addFavorite() method error: ${error}`);
      throw error;
    }
  }
  ...
  async removeFavorite(userId: string, jobId: string): Promise<IUser> {
    try {
      ...
      console.error(`UserRepository - removeFavorite() method error: ${error}`);
      throw error;
    }
  }
  ...
  async getUserFavorites(userId: string): Promise<string[]> {
    try {
      ...
      console.error(
        `UserRepository - getUserFavorites() method error: ${error}`
      );
      throw error;
    }
  }
