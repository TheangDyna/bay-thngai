...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.get('/v1/users/health',
            ...
            ...(fetchMiddlewares<RequestHandler>(UsersController.prototype.getHealth)),

            async function UsersController_getHealth(request: ExRequest, response: ExResponse, next: any) {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.delete('/v1/users/me/favorites/:productId',
            ...(fetchMiddlewares<RequestHandler>(UsersController)),
